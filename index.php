    ...
    <svg style="display: none;">
        <defs>
            ...
            <filter id="svg-thermal">
                <!-- Convert image to grayscale luminance first -->
                <feColorMatrix type="matrix" values="
                    0.33 0.33 0.33 0 0
                    0.33 0.33 0.33 0 0
                    0.33 0.33 0.33 0 0
                ...
                <!-- Map dark-to-light brightness directly into Blue -> Magenta -> Red -> Yellow -> White -->
                <feComponentTransfer in="gray">
                    <feFuncR type="table" tableValues="0.0  0.5  1.0  1.0  1.0"/>
                    <feFuncG type="table" tableValues="0.0  0.0  0.0  0.9  1.0"/>
                    <feFuncB type="table" tableValues="0.5  0.8  0.0  0.0  1.0"/>
                </feComponentTransfer>
            </filter>
        </defs>
    </svg>
